...
/* harmony import */ var pliny_mdx_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8605);
...
const getStaticProps = async ()=>{
    const author = contentlayer_generated__WEBPACK_IMPORTED_MODULE_1__/* .allAuthors.find */ .wz.find((p)=>p.slug === "default");
    return {
        props: {
            author
        }
...
function About({ author  }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(pliny_mdx_components__WEBPACK_IMPORTED_MODULE_2__/* .MDXLayoutRenderer */ .J, {
...
var __webpack_exports__ = __webpack_require__.X(0, [210,676,664,99,121,675,209,576,966,829,611,834,45,447], () => (__webpack_exec__(1473)));
